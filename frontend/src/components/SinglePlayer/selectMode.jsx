...
const SelectMode = () => {
  return (
    ...
    >
      ...
      >
        <FlipCard
          frontText="Suprise Game"
          backText="A hidden challenge is revealed randomly.
          Learners play to test knowledge and win rewards."
          image={surprise}
        />
        <FlipCard
          frontText="Link & Learn"
          backText="Questions or terms are listed on the left side.
             Learners match them with corresponding answers on the right."
          image={match}  
